...
1. オプションメニューの `Image Sequence Mode` をオフにします。
2. 中央のビデオ読み込みエリアでダブルクリックします。
3. 開いたダイアログから動画フォーマットのファイルを選択してください。
...
1. オプションメニューの `Image Sequence Mode` をオンにします。
2. 中央のビデオ読み込みエリアでダブルクリックします。
3. 開いたダイアログから動画フォーマットのファイルを選択してください。

このモードは動画を一度画像シーケンスに変換してから読み込みます。
RDP や ネットワークドライブの関係で動画再生のレスポンスが悪い場合に使用します。
...
1. オプションメニューの `Image Sequence Mode` をオンにします。
2. 中央のビデオ読み込みエリアでダブルクリックします。
3. 開いたダイアログから画像フォーマットのファイルを選択してください。
...
A-B ループが有効な場合は、右側にループ範囲の時間とフレーム番号が追加表示されます。

```
MM:SS / MM:SS    [ 現在フレーム / 総フレーム数 ]      A-B: MM:SS - MM:SS [ 開始フレーム - 終了フレーム ]
```

...
class MFragmentManager:
    ...
    def getColorManagementFragmentInfo(self, *args: Any, **kwargs: Any) -> Any: ...
...
class MPreviewRenderEnvironment:
    def __init__(self, *args: Any, **kwargs: Any) -> Any: ...
...
class MRenderItem:
    ...
    def excludedFromDefaultMaterialOverride(self, *args: Any, **kwargs: Any) -> Any: ...
    def excludedFromPostEffects(self, *args: Any, **kwargs: Any) -> Any: ...
    ...
    def setExcludedFromDefaultMaterialOverride(self, *args: Any, **kwargs: Any) -> Any: ...
    ...
    def ufePathString(self, *args: Any, **kwargs: Any) -> Any: ...
...
class MRenderOverride:
    def __init__(self, *args: Any, **kwargs: Any) -> Any: ...
    def cleanup(self, *args: Any, **kwargs: Any) -> Any: ...
    def colorManagedOperation(self, *args: Any, **kwargs: Any) -> Any: ...
    def getFrameContext(self, *args: Any, **kwargs: Any) -> Any: ...
    def name(self, *args: Any, **kwargs: Any) -> Any: ...
...
class MRenderUtilities:
    ...
    def createPreviewRenderEnvironment(self, *args: Any, **kwargs: Any) -> Any: ...
    def drawSimpleMesh(self, *args: Any, **kwargs: Any) -> Any: ...
    def getIBLPresetPath(self, *args: Any, **kwargs: Any) -> Any: ...
    kAmbientLight: Any = ...
    kDefaultLights: Any = ...
...
class MRenderer:
    ...
    def getOutputTargetOverrideSize(self, *args: Any, **kwargs: Any) -> Any: ...
    ...
    def setOutputTargetOverrideSize(self, *args: Any, **kwargs: Any) -> Any: ...
    def setRenderOverrideName(self, *args: Any, **kwargs: Any) -> Any: ...
    def unsetOutputTargetOverrideSize(self, *args: Any, **kwargs: Any) -> Any: ...
...
class MSceneRender:
    ...
    def objectTypeExclusions(self, *args: Any, **kwargs: Any) -> Any: ...
    def operationType(self, *args: Any, **kwargs: Any) -> Any: ...
    def pluginDisplayFilterExclusions(self, *args: Any, **kwargs: Any) -> Any: ...
...
class MShaderInstance:
    ...
    def addColorManagementTextures(self, *args: Any, **kwargs: Any) -> Any: ...
...
class MUserRenderOperation:
    ...
    def requiresResetDeviceStates(self, *args: Any, **kwargs: Any) -> Any: ...
    def targetOverrideList(self, *args: Any, **kwargs: Any) -> Any: ...
    def viewportRectangleOverride(self, *args: Any, **kwargs: Any) -> Any: ...
